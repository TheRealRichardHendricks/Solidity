...
contract owned
{
    ...
    constructor() public    // function owned() public
    {
        owner = msg.sender;
    }
...
contract TokenERC20
{
     ...
     **/
     constructor(uint256 initialSupply, string tokenName, string tokenSymbol) public  // za function TokenERC20(...) javlja warning, ovo constructor(...) je bolje
     {
...
contract MyAdvancedToken is owned, TokenERC20 
{
    ...
    /* Internal trasnfer, only can be called by this contract */
    function _transfer(address _from, address _to, uint _value) internal 
    {
